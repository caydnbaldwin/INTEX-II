...
// Chart colors using the purple theme
const CHART_COLORS = [
  'oklch(0.45 0.18 280)',  // Primary purple
  'oklch(0.55 0.15 280)',  // Lighter purple
  'oklch(0.65 0.12 280)',  // Even lighter
  'oklch(0.75 0.08 280)',  // Light purple
  'oklch(0.35 0.12 280)',  // Dark purple
]
...
export function ImpactDashboard() {
  ...
  const residentsOverTime = publicImpactSnapshots.map(snapshot => ({
    ...
    reintegrated: snapshot.residentsReintegrated,
  }))

  const healthOverTime = publicImpactSnapshots.map(snapshot => ({
    month: new Date(snapshot.snapshotMonth).toLocaleDateString('en-US', { month: 'short' }),
    healthScore: snapshot.avgHealthScore,
    sessions: Math.round(snapshot.counselingSessions / 10), // Scale for visibility
  }))

  const safehouseData = safehouseMetrics.map(sh => ({
    name: sh.safehouseName.split(' ')[0], // Short name
    capacity: sh.capacity,
    occupancy: sh.currentOccupancy,
    education: sh.avgEducationProgress,
    health: sh.avgHealthScore,
  }))
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <MetricCard
            ...
            value={latestSnapshot.totalResidentsServed}
          ...
          <MetricCard
            ...
            value={latestSnapshot.activeResidents}
            description="Currently in care"
            icon={Home}
            trend="Across 9 safehouses"
          />
          <MetricCard
            title="Counseling Sessions"
            value={latestSnapshot.counselingSessions}
            description="This month"
            icon={Heart}
            trend="Individual & group therapy"
          />
          <MetricCard
            title="Average Health Score"
            value={latestSnapshot.avgHealthScore}
            description="Out of 100"
            icon={TrendingUp}
            trend="+8 points this year"
          />
        </div>
        ...
        <Tabs defaultValue="overview" className="mt-12">
          ...
          <TabsContent value="overview" className="mt-8 space-y-8">
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Monthly snapshot of active and total residents served
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Distribution of successful reintegration pathways
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-[300px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Pie
                          ...
                          labelLine={false}
                        >
                          {reintegrationOutcomes.map((_, index) => (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Safehouse locations across the Philippines
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid gap-6 sm:grid-cols-3">
                  {regionData.map((region, index) => (
                    <div key={region.name} className="flex items-center gap-4">
                      <div 
                        className="h-16 w-16 rounded-xl flex items-center justify-center text-2xl font-bold text-primary-foreground"
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Enrollment and completion rates by program type
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-[300px]">
              ...
              {/* Education Progress Details */}
              <Card>
                <CardHeader>
                  <CardTitle>Program Details</CardTitle>
                  <CardDescription>
                    Completion rates for each education track
                  </CardDescription>
                </CardHeader>
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-3xl">
                    {educationPrograms.reduce((acc, p) => acc + p.enrolled, 0)}
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-3xl">
                    {educationPrograms.reduce((acc, p) => acc + p.completed, 0)}
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  ...
                  <CardTitle className="text-3xl">
                    {Math.round(
                      educationPrograms.reduce((acc, p) => acc + (p.completed / p.enrolled) * 100, 0) / 
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Average health scores and counseling activity over time
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-[300px]">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Comprehensive wellbeing monitoring for all residents
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  {[
          ...
          <TabsContent value="safehouses" className="mt-8 space-y-8">
            {/* Safehouse Comparison Chart */}
            <Card>
              <CardHeader>
                <CardTitle>Safehouse Capacity & Occupancy</CardTitle>
                <CardDescription>
                  Current occupancy vs. capacity across all safehouses
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              {safehouseMetrics.map((safehouse) => (
                <Card key={safehouse.id}>
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>
                      {safehouse.currentOccupancy} of {safehouse.capacity} capacity
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <Progress 
                      value={(safehouse.currentOccupancy / safehouse.capacity) * 100} 
                      className="h-2"
                    />
        ...
        <Card className="mt-12 bg-primary/5 border-primary/20">
          <CardContent className="flex flex-col items-center py-12 text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <a 
                href="#recurring" 
                className="inline-flex items-center justify-center rounded-md border border-primary/30 px-6 py-3 text-sm font-medium text-primary hover:bg-primary/10 transition-colors"
              >
