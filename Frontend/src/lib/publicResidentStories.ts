...
export const publicRepresentativeJourneys: PublicRepresentativeJourneyInput[] = [
  ...
  },
  {
    ...
    description:
      'Completed a sewing and textile arts program, now mentoring younger residents in the same skills.',
    longNarrative:
  ...
  },
  {
    ...
    description:
      'Found confidence through guided art therapy sessions and presented her work at a community exhibition.',
    longNarrative:
  ...
  },
  {
    ...
    description:
      'Advanced from basic literacy to independent reading level within eight months of enrollment.',
    longNarrative:
  ...
  },
  {
    ...
    description:
      'Selected as a peer mentor, helping newly arrived residents adjust to safehouse life and routines.',
    longNarrative:
  ...
  },
  {
    ...
    description:
      'Began supervised independent living skills training including budgeting, cooking, and job readiness.',
    longNarrative:
