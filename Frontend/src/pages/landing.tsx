      ...
      <section id="features" className="py-24 sm:py-32 bg-background">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <FeatureCard icon={Home} title="Safe Shelter" description="Secure, nurturing environments across 9 safehouses in Luzon, Visayas, and Mindanao." />
            <FeatureCard icon={Heart} title="Holistic Care" description="Comprehensive support including nutrition, health monitoring, and emotional wellbeing." />
            <FeatureCard icon={GraduationCap} title="Education" description="Bridge programs, secondary education, vocational training, and literacy support." />
            <FeatureCard icon={Users} title="Reintegration" description="Guided pathways back to family, foster care, or independent living." />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 sm:py-32 bg-muted/30">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <ImpactMetricCard icon={BarChart3} value={impactStatistics.reintegrationRate} suffix="%" label="Reintegration Rate" description="Successfully reintegrated into families or independent living" />
            <ImpactMetricCard icon={Sparkles} value={impactStatistics.counselingSessions} suffix="+" label="Counseling Sessions" description="Individual and group therapy sessions conducted" />
            <ImpactMetricCard icon={Globe} value={impactStatistics.regionsServed} label="Regions Served" description="Coverage across Luzon, Visayas, and Mindanao" />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 sm:py-32 bg-background">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-8 lg:grid-cols-4">
            <StepCard number="01" title="Intake & Assessment" description="Each girl receives a thorough assessment to understand her needs and create a personalized care plan." />
            <StepCard number="02" title="Safe Shelter" description="Immediate placement in one of our secure safehouses with 24/7 care and supervision." />
            <StepCard number="03" title="Healing & Education" description="Comprehensive support including counseling, education, and life skills training." />
            <StepCard number="04" title="Reintegration" description="Gradual transition to family reunification, foster care, or independent living." />
          </div>
        </div>
      </section>
...
function ImpactMetricCard({ icon: Icon, value, suffix = '', label, description }: { icon: React.ElementType; value: number; suffix?: string; label: string; description: string }) {
  return (
